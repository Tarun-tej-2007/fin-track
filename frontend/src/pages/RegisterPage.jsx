    ...
    <div className="min-h-screen bg-[#0a0a0f] mesh-bg flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-sm animate-slide-up">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#f1f0ff]">Create account</h1>
          <p className="text-sm text-[#6b6880] mt-1">Start managing your schedule & finances</p>
        </div>
        ...
        <div className="bg-[#16161f] border border-[#2a2a38] rounded-2xl p-6 shadow-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="text" name="name" value={form.name} onChange={handleChange} placeholder="Alex Johnson" className="input" autoComplete="name" />
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} name="password" value={form.password} onChange={handleChange} placeholder="Min 6 characters" className="input pr-10" autoComplete="new-password" />
                <button type="button" onClick={() => setShowPass((p) => !p)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#6b6880] hover:text-[#a09db5] transition-colors">
            ...
            <div>
              ...
              <input type="password" name="confirm" value={form.confirm} onChange={handleChange} placeholder="Re-enter password" className="input" autoComplete="new-password" />
            </div>
